...
@section('admin')
    ...
    <div class="space-y-6">
        <section class="panel">
            ...
            <p class="mt-1 text-sm muted">Paste Intercom, Crisp, Tawk, custom analytics, or any other HTML/JS. Snippets are output as raw markup for visitors — only super administrators can edit them.</p>
