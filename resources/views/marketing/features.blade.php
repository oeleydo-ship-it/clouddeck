...
<section class="relative overflow-hidden border-b border-slate-200 dark:border-white/10">
    ...
    <div class="relative mx-auto max-w-7xl px-5 py-20 lg:py-28">
        ...
        <p class="mt-6 max-w-2xl text-lg muted">{{ $platform }} is a SaaS panel for provisioning your servers, deploying sites, SSL, workers, backups, staging, and monitoring — in one place.</p>
...
<section class="mx-auto max-w-7xl px-5 py-20">
    <div class="grid gap-x-10 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
        @foreach([
            ['Create or connect servers', 'Spin up a DigitalOcean droplet, or add an Ubuntu server by IP. We install the stack and lock down access.'],
...
<section class="border-t border-slate-200 bg-slate-50 py-20 dark:border-white/10 dark:bg-white/[.02]">
    <div class="mx-auto max-w-3xl px-5 text-center">
        <h2 class="font-display text-3xl font-bold heading">Start with one server.</h2>
        <p class="mt-3 muted">Connect a provider or VPS, add a site, and grow from there with the same tools.</p>
